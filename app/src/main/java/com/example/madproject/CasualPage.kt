    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bottomNavigation.setOnNavigationItemSelectedListener { item ->
            when (item.itemId) {
                ...
                R.id.nav_search -> {
                    Log.d("CasualPage", "search icon tapped, navigating to Home page")
                    val intent = Intent(this, Homepage::class.java)
                    startActivity(intent)
                    finish()
                    true
                ...
                R.id.nav_cart -> {
                    Log.d("CasualPage", "cart icon tapped, navigating to Home page")
                ...
                R.id.nav_profile -> {
                    Log.d("casual page", "profile icon tapped, navigating to profile page")
